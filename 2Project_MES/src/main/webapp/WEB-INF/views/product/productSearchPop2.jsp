...
<script type="text/javascript">
	function search(prod_cd, prod_nm) {
		...
		opener.document.getElementById("productSearchName").value = prod_nm;
		// 자식 창을 닫음
		self.close();
	}
</script>
				...
				<div class="col-lg">
					<div class="card m-0">
						<div class="card-body card-block">
							<form
								action="${pageContext.request.contextPath }/product/productSearchPop2"
									...
									<ul class="pagination">
										...
										<c:if test="${pageDTO.startPage <= pageDTO.pageBlock }">
											<li class="paginate_button page-item previous disabled">
												<a
												href="${pageContext.request.contextPath}/product/productSearchPop2?pageNum=${pageDTO.startPage - pageDTO.pageBlock}&search=${pageDTO.search}&search2=${pageDTO.search2}&search3=${pageDTO.search3}"
										...
										<c:forEach var="i" begin="${pageDTO.startPage }"
											...
											<c:if test="${i!=pageDTO.pageNum }">
												<li class="paginate_button page-item "><a
													class="page-link"
													href="${pageContext.request.contextPath}/product/productSearchPop2?pageNum=${i}&search=${pageDTO.search}&search2=${pageDTO.search2}&search3=${pageDTO.search3}">${i}</a>
												</li>
											</c:if>
										</c:forEach>
										<!-- 현재 -->
