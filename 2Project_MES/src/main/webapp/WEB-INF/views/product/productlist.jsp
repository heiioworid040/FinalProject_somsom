					...
					<div class="col-lg">
						<div class="card m-0">
							<div class="card-body card-block">
								<form action="${pageContext.request.contextPath}/product/productlist" class="form-inline" method="GET">
									<div class="form-group col-6 mb-1">
										<label class="pr-1 form-control-label">품목</label>&nbsp;&nbsp;<input
											type="text" name="search" class="form-control" placeholder="Code / Name">
									</div>
									<div class="col p-0">
...
<!-- 검색어 끝 -->	
	...
	<div class="content">
		<div style="width:100%; height:50px">
			<button type="button" class="btn btn-primary float-right" style="margin: 2px" onclick="location.href='${pageContext.request.contextPath}/product/productwrite'">추가</button>
		</div>
			<div class="animated fadeIn">
				<div class="row">
					<div class="col-lg">
								...
								<table id="bootstrap-data-table"
									...
									<tbody>
										...
										<th scope="row"><input type="checkbox" name="chk"
											id="chk" value="${productDTO.prod_number}" style="zoom:1.8">
