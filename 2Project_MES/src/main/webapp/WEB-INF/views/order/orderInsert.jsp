						...
						<div class="card">
							...
							<div class="card-body">
								<table class="table">
									<thead class="thead-dark">
										<tr>
											<th scope="col">수주업체코드</th><td><input type="text"><button type="button" value="cli" onclick="fun1()">돋보기</button></td>
											<th scope="col">수주일자</th><td><input type="date"></td>
										</tr>
										<tr>
											<th scope="col">담당자</th><td><input type="text"><button type="button" value="emp" onclick="fun1()">돋보기</button></td>
...
<!-- 												<button type="button" class="btn-test" name="btn_can" value="del">-</button> -->
<!-- 											</tr> -->
									...
									<button type="submit" class="btn_can" name="btn_can" value="add" onclick="fun1()">+</button>
