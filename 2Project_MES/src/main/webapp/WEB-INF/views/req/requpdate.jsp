...
<script>
	...
	function essential() {
		...
		if (document.fr.prod_fnm.value == "") {
			alert("하위품명을 입력하세요.");
			document.fr.prod_fnm.focus();
			return false;
		}
...
<body>
	...
	<form action="${pageContext.request.contextPath }/req/requpdatePro" method="POST" name="fr" onsubmit="return essential()">
		<div class="content">
						...
						<div class="card">
							...
							<div class="card-body">	
									<table id="bootstrap-data-table"
										...
										<tbody>		
											<tr>
												<td><input type="hidden" name="req_num" value="${reqDTO.req_num}"></td>
												...
												<td><input type="text" name="prod_fcd" style="width : 60px;" value="${reqDTO.prod_fcd}"></td>
												<td><input type="text" name="prod_fnm" style="width : 100px;" value="${reqDTO.prod_fnm}"></td>
												<td><input type="text" name="req_req" value="${reqDTO.req_req}"
													style="width: 60px;"></td>
												<td><input type="text" name="req_add_emp" value="${reqDTO.req_add_emp}"
													style="width: 60px;"></td>	
												<td><input type="date" name="req_add_date" value="${reqDTO.req_add_date}"
													style="width: 120px;"></td>
												<td><input type="text" name="req_edit_emp" value="${reqDTO.req_edit_emp}"
													style="width: 60px;"></td>
												<td><input type="date" name="req_edit_date" value="${reqDTO.req_edit_date}"
													style="width: 120px;"></td>	
											</tr>
										<tr>
										</tbody>
